...
if __name__ == "__main__":
    ...
    parser.add_argument('--input-dir', help='input image path', default='Humans2/', type=str)
    parser.add_argument('--ext', help='input file extension', default='jpg', type=str)
    parser.add_argument('--output', help='output image path', default='Aligned/', type=str)
    parser.add_argument('--landmarks-model-path', help='landmarks model path', default='shape_predictor_68_face_landmarks.dat', type=str)
